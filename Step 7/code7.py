...
# 1. Renvoie le temps écoulé depuis le début du programme.
# 2. Il augmente à chaque collision laser-alien.
# 3. Met à jour l'affichage du score et du temps.
# 4. L'ancien texte reste visible.
# 5. game_over.write("Votre message ici") après la boucle